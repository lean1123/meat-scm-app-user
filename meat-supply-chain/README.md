...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/zg5FjyElkA)
...
```sh
npx nx serve meat-supply-chain-fe
```

To create a production bundle:

```sh
npx nx build meat-supply-chain-fe
```

To see all available targets to run for a project, run:

```sh
npx nx show project meat-supply-chain-fe
```
